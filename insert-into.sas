...
%macro insertInto(fromTable,toTable,where);
%searchEqualVariables(&fromTable,&toTable,dbvariables);
PROC SQL NOPRINT ;
INSERT INTO &toTable (&dbvariables)
(SELECT &dbvariables FROM &fromTable where &where);
%mend insertInto;
